...
export default function Contact({
  ...
  /*
   * BARBEIRO VINDO DO BOTÃO "AGENDAR"
   *
   * Quando a URL tiver:
   *
   * ?barber=UUID#contato
   *
   * verificamos se o profissional
   * realmente existe na lista atual
   * e já deixamos ele selecionado.
   */
  useEffect(() => {
    const barberId =
